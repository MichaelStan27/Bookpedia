...
@section('content')
    <div class="container mx-auto flex justify-center py-8">
        <div class="bg-white w-1/2 rounded-lg shadow-xl py-2">
            ...
            <form action="{{ route('crud-book', $book) }}" method="post" class="" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                <div class="text-center mt-4 px-[20%]">
                    ...
                    <div class="mb-4">
                        <div class="mb-4 flex justify-evenly">
                            <div><input type="checkbox" name="type[]" id="lend_type" value="loan"
                                @if ($book->loan_price)checked @endif
                    ...
                    <div class="mb-4 
                        @error('loan_price') 
                        @else 
                            @if (is_null($book->loan_price)) hidden 
                            @endif
                        @enderror" id="loan_price">
                    ...
                    <div class="mb-4 
                        @error('sale_price') 
                        @else 
                            @if (is_null($book->sale_price)) hidden 
                            @endif
                        @enderror" id="sale_price">
