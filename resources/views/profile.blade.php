...
@section('content')
    <div class="container mx-auto py-5">
        ...
        <div class="flex flex-wrap justify-between items-center">
            ...
            <button type="button" class="inline-block px-6 py-3 bg-blue-400 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-500 hover:shadow-lg focus:bg-blue-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-600 active:shadow-lg transition duration-150 ease-in-out">Add Book</button>
        </div>
                ...
                <div class="p-5">
                    ...
                    <div class="flex flex-wrap justify-start gap-12">
                        <div class="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-xl outline outline-cyan-700">
                          <img class="w-full h-96 md:h-auto object-cover md:w-48 rounded-t-lg md:rounded-none md:rounded-l-lg" src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/action-thriller-book-cover-design-template-3675ae3e3ac7ee095fc793ab61b812cc_screen.jpg?ts=1637008457" alt="" />
                          <div class="flex flex-col justify-between">
                                <div class="p-6 flex flex-col justify-start">
                                    <h5 class="text-gray-900 text-xl font-medium">Book title</h5>
                                    <h5 class="text-xs mb-4">Book Category</h5>
                                    <h2 class="tracking-widest text-md title-font font-bold text-black-400 mb-4">Rp 10.000</h2>
                                    <h2 class="tracking-widest text-xs text-grey-400 uppercase">Rent & Sell</h2>
                                    <h2 class="tracking-widest text-xs title-font font-bold text-green-400 mb-4 uppercase">Available</h2>
                                </div>
                                <div class=" p-3 flex flex-row justify-around">
                                    <button type="button" class="inline-block px-4 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Edit</button>
                                    <button type="button" class="inline-block px-4 py-2.5 bg-red-600 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-red-700 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-lg transition duration-150 ease-in-out">Delete</button>
                                </div>
                                <div class="p-6 flex flex-col justify-start">
                  ...
                  <div class="flex flex-wrap -m-4 gap-20">
                    ...
                    <div class="md:w-[20%] bg-white  rounded-3xl shadow-xl">
                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            ...
                            <img class="w-full object-cover object-center" src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/action-thriller-book-cover-design-template-3675ae3e3ac7ee095fc793ab61b812cc_screen.jpg?ts=1637008457" alt="Book Cover"/>
                        
                            <div class="p-4">
                                <h2 class="tracking-widest text-xs title-font font-bold text-green-400 mb-1 uppercase ">Price</h2>
                                ...
                                <div class="flex justify-between items-center flex-wrap ">
                                    ...
                                    <span class="text-gray-400 inline-flex items-center leading-none text-sm">
                                        <button type="button" class="inline-block px-3 py-1 bg-blue-400 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-500 hover:shadow-lg focus:bg-blue-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-600 active:shadow-lg transition duration-150 ease-in-out">
                                            Add to Cart
                                        </button>
