                    ...
                    <div class="my-4 py-2">
                        <div class="flex items-center justify-start">
                            ...
                            <label for="membersice" class="block text-xl text-left text-gray-500">
                                <a href="mailto:{{ $Users->email }}" class="text-decoration-none">
                                    {{ $Users->email }}
                                </a>
                            </label>
                        </div>
                    ...
                    <div class="my-4 py-2">
                        <div class="flex items-center justify-start">
                            <img src="https://cdn-icons-png.flaticon.com/512/1077/1077063.png" alt=""
                                class="w-8 h-8 mx-2">
                            <label for="membersice" class="block text-xl text-left text-gray-500">
                                Member since <b>{{ $Users->created_at->format('d F Y') }}</b>
                            </label>
                        </div>
                    </div>
                    <div class="my-4 py-2">
                        ...
                        <div class="my-4 py-2">
                            <div class="flex items-center justify-start">
                                <img src="https://cdn-icons-png.flaticon.com/512/6506/6506327.png" alt=""
                                    class="w-8 h-8 mx-2">
                                <h5 class="text-xl leading-tight text-gray-500">{{ $Users->BalanceWithNotation }}</h5>
                            </div>
                        </div>
                    @endif
                </div>
