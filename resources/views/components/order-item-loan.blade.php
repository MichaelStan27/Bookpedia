...
<div class="flex flex-col p-6 bg-white rounded-md divide-y">
    <div class="flex justify-between pb-3">
        <div class="flex flex-col">
            <a href="{{ route('profile', $transaction->headerTransaction->seller) }}"
                class="font-bold text-lg mb-2">{{ $transaction->headerTransaction->seller->fullname }}</a>
            <div class="leading-relaxed">
                <div class="font-light text-neutral-500">
                    <i class="fa-solid fa-location-pin mr-2"></i>
                    <span>{{ $transaction->headerTransaction->seller->user_address }}</span>
                </div>
                <div class="font-light text-neutral-500">
                    <i class="fa-solid fa-phone mr-2"></i>
                    <span>{{ $transaction->headerTransaction->seller->phone_number }}</span>
                </div>
            </div>
        </div>
    ...
    <div class="flex pt-5">
        ...
        <div class="flex flex-col items-end flex-grow justify-between">
            ...
            @if ($transaction->loanDetails->deliveryStatus->is('loan'))
